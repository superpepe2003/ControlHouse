...
namespace ControlHouse.Controllers
{
    public class ManageController : Controller
    {
        ...
        private List<ApplicationUser> Listado()
        {
        ...
        private void CrearAdmin()
        {
            using (ApplicationDbContext db = new ApplicationDbContext())
            {
                ...
                {
                    var Irole = roleManager.Create(new IdentityRole("Administrador"));

                    var u = new ApplicationUser();
                    u.Email = "pablo_fretes@hotmail.com";
                    u.UserName = "pablo_fretes@hotmail.com";

                    var result = UserManager.CreateAsync(u, "silpab");

                    if (result.Result.Succeeded)
                    {
                        //SignInManager.SignInAsync(u, isPersistent: false, rememberBrowser: false);

                        var user = UserManager.FindByName("pablo_fretes@hotmail.com");
                        var resultado = UserManager.AddToRole(user.Id, "Administrador");
                    }
